...
- **Skills used**: `suede-seo-audit`, `suede-programmatic-seo`, `suede-content-strategy`
- **Loop body**:
...
- **Skills used**: `suede-seo-audit`, `suede-analytics`
- **Loop body**:
...
- **Skills used**: `suede-copy`, `suede-seo-audit`, `suede-content-strategy`
- **Loop body**:
...
- **Skills used**: `suede-seo-audit`, `suede-content-strategy`
- **Loop body**:
...
- **Skills used**: `suede-programmatic-seo`, `suede-seo-audit`
- **Loop body**:
...
- **Skills used**: `suede-social`, `suede-content-strategy`, `suede-copy`
- **Loop body**:
...
- **Skills used**: `suede-content-strategy`, `suede-marketing-ideas`, `suede-seo-audit`
- **Loop body**:
...
- **Skills used**: `suede-ads`, `suede-ad-creative`, `suede-analytics`
- **Loop body**:
...
- **Skills used**: `suede-ads`, `suede-analytics`
- **Loop body**:
...
- **Skills used**: `suede-site-alchemy`, `suede-analytics`
- **Loop body**:
...
- **Skills used**: `suede-public-relations`, `suede-social`
- **Loop body**:
...
- **Skills used**: `suede-social`, `suede-community-marketing`
- **Loop body**:
...
- **Skills used**: `suede-community-marketing`, `suede-social`
- **Loop body**:
...
- **Skills used**: `suede-competitor-profiling`, `suede-competitors`, `suede-product-marketing`
- **Loop body**:
...
- **Skills used**: `suede-public-relations`, `suede-seo-audit`
- **Loop body**:
...
- **Skills used**: `suede-directory-submissions`
- **Loop body**:
...
- **Skills used**: `suede-co-marketing`, `suede-referrals`
- **Loop body**:
...
- **Skills used**: `suede-onboarding`, `suede-analytics`, `suede-site-alchemy`
- **Loop body**:
...
- **Skills used**: `suede-signup`, `suede-site-alchemy`, `suede-analytics`, `suede-ab-testing`
- **Loop body**:
  ...
  3. Draft a hypothesis + test for the worst step (hand test execution to `suede-ab-testing`).
...
- **Output**: A prioritized experiment brief for `suede-ab-testing`.
...
- **Skills used**: `suede-lead-magnets`, `suede-free-tools`, `suede-site-alchemy`
- **Loop body**:
...
- **Skills used**: `suede-onboarding`, `suede-emails`, `suede-analytics`
- **Loop body**:
...
- **Skills used**: `suede-churn-prevention`, `suede-analytics`, `suede-emails`
- **Loop body**:
...
- **Skills used**: `suede-emails`, `suede-sms`, `suede-offers`
- **Loop body**:
...
- **Skills used**: `suede-emails`, `suede-analytics`
- **Loop body**:
...
- **Skills used**: `suede-customer-research`, `suede-churn-prevention`, `suede-referrals`, `suede-copy`
- **Loop body**:
  1. Collect new feedback across sources.
  2. Route: detractors/at-risk → save motion (`suede-churn-prevention`); promoters → referral/review ask (`suede-referrals`); recurring pain/desire → experiment + copy inputs.
...
- **Skills used**: `suede-emails`, `suede-paywalls`, `suede-analytics`, `suede-offers`
- **Loop body**:
...
- **Skills used**: `suede-analytics`, `suede-sales-enablement`, `suede-revops`
- **Loop body**:
...
- **Skills used**: `suede-revops`, `suede-sales-enablement`, `suede-emails`
- **Loop body**:
...
- **Skills used**: `suede-referrals`, `suede-emails`
- **Loop body**:
...
- **Skills used**: `suede-social`, `suede-referrals`, `suede-sales-enablement`, `suede-site-alchemy`
- **Loop body**:
...
- **Skills used**: `suede-sales-enablement`, `suede-social`, `suede-site-alchemy`
- **Loop body**:
...
- **Skills used**: `suede-sales-enablement`, `suede-customer-research`, `suede-referrals`
- **Loop body**:
...
- **Loop body**:
  ...
  3. If a slot is free, hand the top idea to `suede-ab-testing`; if a test concluded there, log the learning.
...
- **Stop / bail-out**: Backlog full and a test running → just log new ideas. Don't duplicate `suede-ab-testing`'s job.
- **Output**: An updated, ranked backlog (the source of record lives with `suede-ab-testing`).
...
- **Skills used**: `suede-social`, `suede-public-relations`
- **Loop body**:
...
- **Skills used**: `suede-analytics`, `suede-marketing-plan`
- **Loop body**:
