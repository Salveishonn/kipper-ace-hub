...
import AdminRecursosGraficos from "@/pages/admin/AdminRecursosGraficos";
...
vi.mock("@/hooks/useDesignResources", () => ({
  ...
  useSaveDesignResource: () => ({ mutate: vi.fn(), mutateAsync: vi.fn(), isPending: false }),
...
describe("admin recursos gráficos preview", () => {
  ...
  it("keeps edit controls on the card", () => {
    render(wrap());
